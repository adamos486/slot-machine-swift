...
class ViewController: UIViewController {
    ...
    func setupFirstContainer(forContainer containerView: UIView) {
        ...
        self.titleLabel.font = UIFont(name: "AvenirNext-BoldItalic", size: 40)
    ...
    func setupSecondContainer(forContainer containerView: UIView) {
        for var containerNumber = 0; containerNumber < kNumberOfContainers; ++containerNumber {
            for var slotNumber = 0; slotNumber < kNumberOfSlots; ++slotNumber {
                ...
                slotImageView.backgroundColor = UIColor.brownColor()
                slotImageView.frame =
                    CGRect(
    ...
    func setupThirdContainer(forContainer containerView: UIView) {
        ...
        self.creditsLabel.center = CGPoint(x: containerView.frame.width * kSixth,
        ...
        self.betLabel.center = CGPoint(x: containerView.frame.width * kSixth * 3,
            y: containerView.frame.height * kThird)
        ...
        self.winnerPaidLabel.center = CGPoint(x: containerView.frame.width * kSixth * 5,
            y: containerView.frame.height * kThird)
        ...
        self.creditsTitleLabel.center = CGPoint(x: containerView.frame.width * kSixth,
